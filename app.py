...
st.sidebar.title("OLYMPIC MENU")
st.sidebar.image('https://c4.wallpaperflare.com/wallpaper/96/620/60/paint-smoke-ring-olympics-wallpaper-preview.jpg')
st.image('https://c4.wallpaperflare.com/wallpaper/443/195/686/olympic-bright-circle-colorful-wallpaper-preview.jpg')
...
if user_menu == 'Overall':
    ...
    participants_over_time = helper.data_over_time(df, 'Name')
    fig = px.line(participants_over_time, x="Edition", y="Name")
